/**
 * GET /api/dashboard/daily?from=YYYY-MM-DD&until=YYYY-MM-DD&force=1
 *
 * 응답:
 *   range, fetchedAt, settings, daily[], metaError, cached
 *
 * daily 한 row =
 *   { date, netRevenue, vat, pgFee, reportCost, adSpend,
 *     contributionProfit, contributionMargin, roas, breakEvenRoas,
 *     reportCount, paidAmount, cancelledAmount }
 */
